...
namespace EmployeePayrollTest
{
	...
	BasicPay,Deduction,TaxablePay,Tax,NetPay,City,Country from Day36_Payroll_Service";
        ...
        public bool AddEmployee(EmployeeDetails employeeModel)
        {
            try
            {
                using (connection)
                {
                    SqlCommand command = new SqlCommand("SpAddEployeedetails2", connection);
